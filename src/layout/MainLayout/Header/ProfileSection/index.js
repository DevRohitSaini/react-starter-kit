...
const ProfileSection = () => {
  ...
  const onConfirmPressLogOut = () => {
    localStorage.removeItem('token');
    localStorage.removeItem('user');
    localStorage.removeItem('role');
    localStorage.removeItem('hasPunchedIn');
    //localStorage.setItem('hasPunchedIn', JSON.stringify(false));
              ...
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  ...
                  <ListItemButton selected={selectedIndex === 4}>
                    ...
                    <ListItemText primary="Logout" onClick={onConfirmPressLogOut} />
                  </ListItemButton>
                </List>
              </ClickAwayListener>
            </Paper>
